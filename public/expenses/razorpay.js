...
async function GetUserdata() {
    try {
        ...
        let getdata = await axios.get("http://54.147.36.233:3000/user/getUserdata", { headers: { 'Authorization': token } });
...
rzp_button.onclick = async (eve) => {
    try {
        eve.preventDefault();
        const token = localStorage.getItem('token');
        const response = await axios.get("http://54.147.36.233:3000/premiumfeatur/purchasepremium", { headers: { 'Authorization': token } });
        ...
        var options = {
            ...
            "handler": async function (response) {
                await axios.post("http://54.147.36.233:3000/premiumfeatur/update_transation_status", {
...
function LeaderBoard() {
    try {
        ...
        leaderbordBtn.onclick = async (eve) => {
            ...
            const getUserLeaderBoardArray = await axios.get('http://54.147.36.233:3000/premiumfeatur/showLeaderBoard', { headers: { 'Authorization': token } });
...
function fordownloading() {
    try {
        ...
        DownloaddBtn.onclick = async (eve) => {
            ...
            const getUserDownloadedData = await axios.get('http://54.147.36.233:3000/download/Download', { headers: { 'Authorization': token } });
